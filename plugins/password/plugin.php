...
function password_tab()
{
   ...
   $html .= "<tr><td style=\"width:10%;white-space:nowrap;\">Enable password:&nbsp;&nbsp;</td><td><select name=\"password-enabled\" size=\"1\"><option value=\"0\"";
   ...
   $html .= "<tr><td>Password:</td><td><input name=\"password\" size=\"25\" value=\"$password\"></td></tr>";
