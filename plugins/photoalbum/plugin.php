...
function photoalbum_tab()
{
   ...
   $html .= "<tr><td style=\"width:10%;white-space:nowrap;\">Enable photo album:&nbsp;&nbsp;</td><td><select name=\"photoalbum-enabled\" size=\"1\"><option value=\"0\"";
   ...
   $html .= "<tr><td>Images folder:</td><td><input name=\"photoalbum-folder\" style=\"width:100%;\" value=\"$photoalbum_folder\"></td></tr>";
   $html .= "<tr><td>Columns:</td><td><input name=\"photoalbum-columns\" size=\"4\" value=\"$photoalbum_columns\"></td></tr>";
   $html .= "<tr><td>Rows:</td><td><input name=\"photoalbum-rows\" size=\"4\" value=\"$photoalbum_rows\"></td></tr>";
   $html .= "<tr><td>Thumbnail size:</td><td><input name=\"photoalbum-size\" size=\"4\" value=\"$photoalbum_size\"></td></tr>";
   $html .= "</table>\n";
