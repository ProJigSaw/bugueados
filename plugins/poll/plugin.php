...
function poll_tab()
{
   ...
   if ($poll_action == 'edit' || $poll_action == 'new')
   {
      ...
      $html .= "<tr>\n";
      $html .= "<td>Option:</td><td><input type=\"text\" name=\"poll-option\" value=\"" .$poll_option. "\" style=\"width:100%;\"></td>\n";
      $html .= "</tr>\n";
      $html .= "<tr>\n";
      $html .= "<td>Votes:</td><td><input type=\"text\" name=\"poll-votes\" value=\"" .$poll_votes. "\" size=\"5\"></td>\n";
      $html .= "</tr>\n";
      $html .= "<tr>\n";
      $html .= "<td>&nbsp;</td><td>\n";
   ...
   else
   {
      ...
      $html .= "<tr><td style=\"width:10%;white-space:nowrap;\">Enable poll for this page:&nbsp;&nbsp;</td><td><select name=\"poll-enabled\" size=\"1\"><option value=\"0\"";
      if ($poll_enabled == 0)
      {
         $html .= " selected";
      }
      ...
      $html .= "<tr><td>Poll title:</td><td><input name=\"poll-title\" style=\"width:100%;\" value=\"$poll_title\"></td></tr>";
      $html .= "<tr><td>Question:</td><td><input name=\"poll-question\" style=\"width:100%;\" value=\"$poll_question\"></td></tr>";
      $html .= "</table><br>\n";
