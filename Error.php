...
<div id="space"><br></div>
<div id="container">
<div id="wb_Text1" style="position:absolute;left:410px;top:395px;width:430px;height:18px;text-align:center;z-index:20;">
<span style="color:#FFFFFF;font-family:Arial;font-size:16px;">Redireccionando espere un momento</span></div>
<div id="wb_Text2" style="position:absolute;left:260px;top:340px;width:730px;height:55px;text-align:center;z-index:21;">
<span style="color:#696969;font-family:Arial;font-size:48px;">Lo sentimos intente más tarde</span></div>
<div id="wb_Text3" style="position:absolute;left:465px;top:210px;width:320px;height:156px;text-align:center;z-index:22;">
<span style="color:#FF0000;font-family:Impact;font-size:128px;"><strong>!</strong></span></div>
</div>
...
<div id="wb_Text5" style="position:absolute;left:390px;top:35px;width:220px;height:22px;text-align:center;z-index:5;">
...
<a href="https://www.facebook.com/Bugueados?ref=hl" target="_blank"><img class="hover" src="images/img0019_hover.png" alt="" style="border-width:0;width:50px;height:50px;"><span><img src="images/img0019.png" id="ClipArt1" alt="" style="width:50px;height:50px;"></span></a></div>
<div id="wb_ClipArt2" style="position:absolute;left:20px;top:20px;width:50px;height:50px;z-index:7;">
<a href="https://twitter.com/Bugueados" target="_blank"><img class="hover" src="images/img0020_hover.png" alt="" style="border-width:0;width:50px;height:50px;"><span><img src="images/img0020.png" id="ClipArt2" alt="" style="width:50px;height:50px;"></span></a></div>
<div id="wb_Text6" style="position:absolute;left:70px;top:35px;width:220px;height:22px;text-align:center;z-index:8;">
...
<a href=""><img class="hover" src="images/img0021_hover.png" alt="" style="border-width:0;width:50px;height:50px;"><span><img src="images/img0021.png" id="ClipArt4" alt="" style="width:50px;height:50px;"></span></a></div>
...
<div id="wb_Text7" style="position:absolute;left:1050px;top:20px;width:190px;height:48px;text-align:center;z-index:11;">
...
<div id="wb_Text8" style="position:absolute;left:0px;top:0px;width:130px;height:16px;text-align:center;z-index:16;">
