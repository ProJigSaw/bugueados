...
<div id="space"><br></div>
<div id="container">
<iframe id="CmsAdmin1" name="cmsadmin" style="position:absolute;left:0px;top:110px;width:1250px;height:500px;z-index:20;" src="./cmsadmin.php"></iframe>
</div>
<div id="Layer1" style="position:absolute;text-align:center;left:0px;top:690px;width:100%;height:90px;z-index:21;">
...
<a href="https://www.facebook.com/Bugueados?ref=hl" target="_blank"><img class="hover" src="images/img0087_hover.png" alt="" style="border-width:0;width:50px;height:50px;"><span><img src="images/img0087.png" id="ClipArt1" alt="" style="width:50px;height:50px;"></span></a></div>
<div id="wb_ClipArt2" style="position:absolute;left:20px;top:20px;width:50px;height:50px;z-index:7;">
<a href="https://twitter.com/Bugueados" target="_blank"><img class="hover" src="images/img0088_hover.png" alt="" style="border-width:0;width:50px;height:50px;"><span><img src="images/img0088.png" id="ClipArt2" alt="" style="width:50px;height:50px;"></span></a></div>
...
<a href=""><img class="hover" src="images/img0089_hover.png" alt="" style="border-width:0;width:50px;height:50px;"><span><img src="images/img0089.png" id="ClipArt4" alt="" style="width:50px;height:50px;"></span></a></div>
...
<div id="Layer4" style="position:fixed;text-align:center;left:0;top:0;right:0;height:70px;z-index:22;">
...
<div id="wb_Text1" style="position:absolute;left:0px;top:0px;width:130px;height:16px;text-align:center;z-index:16;">
