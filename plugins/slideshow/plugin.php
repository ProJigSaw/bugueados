...
function slideshow_tab()
{
   ...
   $html .= "<tr><td style=\"width:10%;white-space:nowrap;\">Enable slide show:&nbsp;&nbsp;</td><td><select name=\"slideshow-enabled\" size=\"1\"><option value=\"0\"";
   if ($slideshow_enabled == 0)
   {
      $html .= " selected";
   }
   ...
   $html .= "<tr><td>Images folder:</td><td><input name=\"slideshow-folder\" style=\"width:100%;\" value=\"$slideshow_folder\"></td></tr>";
   $html .= "<tr><td>Width:</td><td><input name=\"slideshow-width\" size=\"4\" value=\"$slideshow_width\"></td></tr>";
   $html .= "<tr><td>Height:</td><td><input name=\"slideshow-height\" size=\"4\" value=\"$slideshow_height\"></td></tr>";
   $html .= "<tr><td>URL:</td><td><input name=\"slideshow-url\" style=\"width:100%;\" value=\"$slideshow_url\"></td></tr>";
   $html .= "<tr><td>Target:</td><td><input name=\"slideshow-target\" style=\"width:100%;\" value=\"$slideshow_target\"></td></tr>";
   $html .= "<tr><td>Effect:</td><td><select name=\"slideshow-effect\" size=\"1\"><option value=\"none\"";
   ...
   $html .= "<tr><td>Duration:</td><td><input name=\"slideshow-duration\" size=\"4\" value=\"$slideshow_duration\"></td></tr>";
   $html .= "<tr><td>Interval:</td><td><input name=\"slideshow-interval\" size=\"4\" value=\"$slideshow_interval\"></td></tr>";
