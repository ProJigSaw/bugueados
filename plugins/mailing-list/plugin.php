...
define("MAILINGLIST_INPUT_WIDTH", 350);
...
function mailinglist_after_content($id)
{
   ...
   if ($mailinglist_display_name)
   {
      $cms_content .= "<tr><td>".MAILINGLIST_NAME."</td><td><input class=\"cms_input\" name=\"mailinglist-name\" style=\"width:".MAILINGLIST_INPUT_WIDTH."px\"></td></tr>\n";
   }
   $cms_content .= "<tr><td>".MAILINGLIST_EMAIL."</td><td><input class=\"cms_input\" type=\"email\" name=\"mailinglist-email\" style=\"width:".MAILINGLIST_INPUT_WIDTH."px\"></td></tr>\n";
   if ($mailinglist_display_phone)
   {
      $cms_content .= "<tr><td>".MAILINGLIST_PHONE."</td><td><input class=\"cms_input\" name=\"mailinglist-phone\" style=\"width:".MAILINGLIST_INPUT_WIDTH."px\"></td></tr>\n";
   }
...
function mailinglist_tab()
{
   ...
   if ($mailinglist_action == 'edit' || $mailinglist_action == 'new')
   {
      ...
      $html .= "<tr>\n";
      $html .= "<td>Name:</td><td><input type=\"text\" name=\"mailinglist-name\" value=\"" .$mailinglist_name. "\" style=\"width:100%;\"></td>\n";
      $html .= "</tr>\n";
      $html .= "<tr>\n";
      $html .= "<td>Email:</td><td><input type=\"text\" name=\"mailinglist-email\" value=\"" .$mailinglist_email. "\" style=\"width:100%;\"></td>\n";
      $html .= "</tr>\n";
      $html .= "<tr>\n";
      $html .= "<td>Phone:</td><td><input type=\"text\" name=\"mailinglist-phone\" value=\"" .$mailinglist_phone. "\" style=\"width:100%;\"></td>\n";
      $html .= "</tr>\n";
      $html .= "<tr>\n";
      $html .= "<td>&nbsp;</td><td>\n";
   ...
   if ($mailinglist_action == 'message')
   {
      ...
      $html .= "</script>\n";
      $html .= "<table>\n";
      $html .= "<tr><td>Subject:</td><td><input name=\"mailinglist-subject\" style=\"width:100%;\"></td></tr>\n";
      $html .= "<tr><td>Message:</td><td><textarea name=\"mailinglist-body\" style=\"width:100%;\" cols=\"100\" rows=\"10\"></textarea></td></tr>\n";
  ...
  else
   {
      ...
      $html .= "<tr><td style=\"width:10%;white-space:nowrap;\">Enable mailinglist for this page:&nbsp;&nbsp;</td><td><select name=\"mailinglist-enabled\" size=\"1\"><option value=\"0\"";
      if ($mailinglist_enabled == 0)
      {
         $html .= " selected";
      }
      ...
      $html .= "<tr><td>Email from:</td><td><input name=\"mailinglist-from\" style=\"width:100%;\" value=\"$mailinglist_from\"></td></tr>";

      $html .= "<tr><td>Display name field:</td><td><select name=\"mailinglist-display-name\" size=\"1\"><option value=\"0\"";
      ...
      $html .= "<tr><td>Display phone field:</td><td><select name=\"mailinglist-display-phone\" size=\"1\"><option value=\"0\"";
