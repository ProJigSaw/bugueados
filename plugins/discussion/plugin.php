...
define("DISCUSSION_INVALID_CAPTCHA", "&bull; The CAPTCHA wasn't entered correctly: ");
...
define("DISCUSSION_INPUT_WIDTH", 350);
...
function discussion_display_after($id)
{
   ...
   if ($action == 'discussion_new')
   {
	 ...
	 $topic_subject = "";
      ...
      $cms_content .= "<table>\n";
      $cms_content .= "<tr><td>".DISCUSSION_SUBJECT."</td><td><input class=\"cms_input\" name=\"discussion-subject\" style=\"width:".DISCUSSION_INPUT_WIDTH."px\" value=\"$topic_subject\"></td></tr>\n";
      $cms_content .= "<tr><td>".DISCUSSION_NAME."</td><td><input class=\"cms_input\" name=\"discussion-author\" style=\"width:".DISCUSSION_INPUT_WIDTH."px\"></td></tr>\n";
      $cms_content .= "<tr><td>".DISCUSSION_DESCRIPTION."</td><td><textarea class=\"cms_textarea\" name=\"discussion-description\" style=\"width:".DISCUSSION_INPUT_WIDTH."px\" rows=\"10\"></textarea></td></tr>\n";
      if ($captcha_public_key != '')
      {
...
function discussion_tab()
{
   ...
   $html .= "<tr><td style=\"width:10%;white-space:nowrap;\">Enable discussion for this page:&nbsp;&nbsp;</td><td><select name=\"discussion-enabled\" size=\"1\"><option value=\"0\"";
   if ($discussion_enabled == 0)
   {
      $html .= " selected";
   }
   ...
   $html .= "<tr><td>reCAPTCHA public key:</td><td><input name=\"discussion-publickey\" style=\"width:100%;\" value=\"$captcha_public_key\"></td></tr>";
   $html .= "<tr><td>reCAPTCHA private key:</td><td><input name=\"discussion-privatekey\" style=\"width:100%;\" value=\"$captcha_private_key\"></td></tr>";
   $html .= "</table><br>\n";
