...
function downloads_tab()
{
   ...
   $html .= "<tr><td style=\"width:10%;white-space:nowrap;\">Enable downloads:&nbsp;&nbsp;</td><td><select name=\"downloads-enabled\" size=\"1\"><option value=\"0\"";
   if ($downloads_enabled == 0)
   {
      $html .= " selected";
   }
   ...
   $html .= "<tr><td>Folder:</td><td><input name=\"downloads-folder\" style=\"width:100%;\" value=\"$downloads_folder\"></td></tr>";
   $html .= "<tr><td>Filter:</td><td><input name=\"downloads-filter\" style=\"width:100%;\" value=\"$downloads_filter\"></td></tr>";
   $html .= "<tr><td>Bullet:</td><td><input name=\"downloads-bullet\" style=\"width:100%;\" value=\"$downloads_bullet\"></td></tr>";
