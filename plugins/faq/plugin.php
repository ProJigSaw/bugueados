...
function faq_tab()
{
   ...
   if ($faq_action == 'edit' || $faq_action == 'new')
   {
      ...
      $html .= "<tr><td style=\"width:5%;white-space:nowrap;\">Question:&nbsp;&nbsp;</td><td><input type=\"text\" name=\"faq-question\" value=\"" .$question. "\" style=\"width:100%;\"></td></tr>\n";
      $html .= "<tr><td>Answer:</td><td><textarea style=\"width:100%;height:250px\" name=\"faq-answer\">".$answer."</textarea></td></tr>\n";
      $html .=  "<tr><td>&nbsp;</td>\n";
      $html .= "<td align=left>\n";
